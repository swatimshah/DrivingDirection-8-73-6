...
# Compile the model   
adam = Adam(learning_rate=0.00015)
...
hist = model.fit(input, Y_train, batch_size=32, epochs=40, verbose=1, validation_data=(testinput, Y_test), steps_per_epoch=None, callbacks=[es, mc])
